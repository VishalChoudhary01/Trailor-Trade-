...
import Logo from "../app/components/atoms/TrailorTradeLogo";
    ...
    <>
      <div className={`flex justify-center`}>
        <nav
          ...
          } flex items-center justify-between xl:px-[6.5rem] py-1 px-2 transition-all duration-300 ${
            isScrolled
        ...
        >
          ...
          >
            {isMobileMenuOpen ? (
              ...
              <IoMdMenu
                className={isScrolled ? "text-[#1959AC]" : "text-white"}
              />
            )}
          </button>
        </nav>
            ...
            >
              ...
              <div className="bg-[#1959AC] p-6 text-white">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-bold font-roboto_condensed">
                    Menu
                  </h2>
                  <button
                    onClick={closeMobileMenu}
              ...
              <div className="p-6 h-[calc(100vh-80px)] overflow-y-auto">
                <ul className="space-y-2">
                  {menuItems.map((item, index) => (
                    <div
                      key={index}
                      className={`font-inter border-b border-gray-100 last:border-b-0`}
                    >
                      <div
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <p className="text-[#1959AC] font-semibold">
                    +1 (555) 123-RIDE
                  </p>
                  <p className="text-gray-600 text-sm mt-1">
                    support@ridebeyond.com
                  </p>
                </div>
              </div>
            </motion.div>
